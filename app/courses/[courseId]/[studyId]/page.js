    ...
    <div>
      ...
      <div className="df aic">
        <div className="df fdc" style={{ height: "100vh", backgroundColor: "var(--blackDark)" }}>
          ...
          <div className="df fdc"> {" "} {course?.sections?.map((section) => (
              <div className="df fdc" key={section.name}>
                ...
                <div className="mb5">
                  {section.videos.map((video) => {
                    <CourseSectionVideo key={video.title} video={video} setSelectedVideo={setSelectedVideo} isAuthenticated={isAuthenticated}
        ...
        <div className="p10" style={{ height: "100vh", minWidth: "70%" }}>
          ...
          <CourseVideo videoUrl={selectedVideo?.videoUrl} isFree={!!selectedVideo?.free} hasBoughtTheCourse={course?.hasBoughtTheCourse}/>
        </div>
      </div>
    </div>
  );
